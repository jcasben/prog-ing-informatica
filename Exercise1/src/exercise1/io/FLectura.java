...
public class FLectura {
    ...
    //Metodo que lee el contenido del fichero, lo guarda en un String y posteriormente, lo imprime. De esta manera,
    //el usuario puede visualizar el contenido del fichero
    public void leer() {
        String lectura = "";
        try {
            c = fr.read();
